...
class camera {
    public:
        ...
        vec3 lookfrom = point3( 0, 0, -1);   // Point the camera is looking from
    ...
    private:
        ...
        ray get_ray(int i, int j) const {
            // Get a randomly sampled camera ray from pixel at location i,j originating from
        ...
        vec3 pixel_sample_square() const {
            //Returns a randome point in the square surrounding a pixel
