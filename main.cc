...
int main() {
    ...
    auto material_left   = make_shared<dielectric>(color(0.8,1.0,0.7),1.5);
    auto material_right  = make_shared<metal>(color(0.8, 0.6, 0.2), 0.1);
    auto material_back   = make_shared<lambertian>(color(0.9,0.1,0.6));
    ...
    world.add(make_shared<sphere>(point3(-0.5,  0.0,   -0.5), 0.5, material_back));
